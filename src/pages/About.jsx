  ...
  return (
    <div>
      <section className="relative overflow-hidden bg-voice-black">
        <PhotoBand src="/images/animal-turkey.jpg" />
      ...
      <section className="relative overflow-hidden bg-voice-black">
        <PhotoBand src="/images/animal-cow.jpg" />
      ...
      {/* Partner orgs */}
      <section className="relative overflow-hidden bg-voice-ink border-t border-voice-gold/20">
      ...
      {/* Founders' note */}
      <section className="relative overflow-hidden bg-voice-ink border-t border-voice-gold/20">
        <PhotoBand src="/images/animal-calf.jpg" />
        <div className="py-16 md:py-20 px-6 md:px-10">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
